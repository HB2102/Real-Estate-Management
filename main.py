...
from routers_general import user, region, city, asset_type, bargain_type
from routers_admin import admin_user, admin_region, admin_city, admin_asset_type, admin_bargain_type
